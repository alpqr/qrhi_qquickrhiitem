...
void ExampleRhiItemRenderer::initialize(QRhiCommandBuffer *cb)
{
    ...
    if (!m_pipeline) {
        ...
        m_pipeline->setShaderStages({
           { QRhiShaderStage::Vertex, getShader(QLatin1String(":/testapp/shaders/color.vert.qsb")) },
           { QRhiShaderStage::Fragment, getShader(QLatin1String(":/testapp/shaders/color.frag.qsb")) }
        });
