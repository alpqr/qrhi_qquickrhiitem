...
Item {
    TestItem {
        ...
        textureFormat: rdFormatRGBA8.checked ? TestItem.RGBA8
                                             : rdFormatFP16.checked ? TestItem.RGBA16F
                                                                    : rdFormatFP32.checked ? TestItem.RGBA32F
                                                                                           : TestItem.RGB10A2
    ...
    SettingsDrawer {
        ...
        CheckBox {
            id: cbBlend
            text: qsTr("Enable alpha blending\n(even if nothing else triggers it)")
            checked: false
        }
        RowLayout {
            Label {
